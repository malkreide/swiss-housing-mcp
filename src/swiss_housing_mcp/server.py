...
mcp = MCPServer(
    ...
    instructions=(
        ...
        "searches dumps already cached in this process, plus a seed covering "
        "261, so on a cold cache it fails for every other municipality. Pass "
        "`canton` whenever you know it instead of waiting for that failure.\n"
